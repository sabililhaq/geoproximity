			...
			<div class="px-actions">
				...
				<div class="px-io-row">
					<button type="button" data-sample title="${esc(t.sample)}" aria-label="${esc(t.sample)}">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z"></path><path d="M8 8h8v8H8z"></path></svg><span class="px-action-label">${esc(t.sampleButton)}</span>
					</button>
					<button type="button" data-share hidden title="${esc(t.share)}" aria-label="${esc(t.share)}">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg><span class="px-action-label">${esc(t.shareButton ?? 'Share')}</span>
					</button>
					<button type="button" data-fit disabled title="${esc(t.fit)}" aria-label="${esc(t.fit)}">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14v6h6"/><path d="M20 10V4h-6"/><path d="M14 20h6v-6"/><path d="M10 4H4v6"/></svg><span class="px-action-label">${esc(t.fitButton ?? 'Fit all')}</span>
					</button>
					<button type="button" data-clear class="px-danger" disabled title="${esc(t.clear)}" aria-label="${esc(t.clear)}">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg><span class="px-action-label">${esc(t.clearButton ?? 'Clear')}</span>
					</button>
				</div>
			</div>
		</aside>
